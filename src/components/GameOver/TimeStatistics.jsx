      ...
      <div className="statisticsText">
        ...
        <div className="infoIcon">
          ...
          <div className="infoWindow">
            ...
            <h5>
              This index is calculated considering the average time spent
              answering questions compared to 10 seconds, the time considered
              normal for answering a question.
            </h5>
          </div>
        </div>
      </div>
